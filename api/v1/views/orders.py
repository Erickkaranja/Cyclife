...
@app_views.route('/user/<user_id>/order', methods=['GET'], strict_slashes=False)
...
@app_views.route('/user/<user_id>/order', methods=['POST'], strict_slashes=False)
...
@app_views.route('/order/<order_id>', methods=['DELETE'], strict_slashes=False)
